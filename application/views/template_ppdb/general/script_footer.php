...
<script src="<?php echo base_url(); ?>assets/ppdb/dist/assets/plugins/custom/ckeditor/ckeditor-classic.bundle.js"></script>
<!--end::Page Vendors-->
...
<script src="<?php echo base_url(); ?>assets/ppdb/dist/assets/js/pages/crud/forms/editors/ckeditor-classic.js"></script>
...
<script src="<?php echo base_url(); ?>assets/ppdb/dist/assets/js/pages/crud/forms/widgets/bootstrap-timepicker.js">
</script>
<script>
    $('.dropify').dropify({
        messages: {
