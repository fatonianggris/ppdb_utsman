...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url(); ?>assets/students/dist/assets/css/pages/error/error-5.css" rel="stylesheet" type="text/css" />
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled sidebar-enabled page-loading">
        ...
        <div class="d-flex flex-column flex-root">
            <!--begin::Error-->
            <div class="error error-5 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(<?php echo base_url(); ?>assets/students/dist/assets/media/error/bg5.jpg);">
                <!--begin::Content-->
