/******/ (() => { // webpackBootstrap
	...
	var KTDatatableHtmlTableDemo = function () {
		...
		var demo = function () {
			...
			$('#kt_datatable_search_accept').on('change', function () {
				datatable.search($(this).val().toLowerCase(), 'Penerimaan');
			});
			...
			$('#kt_datatable_search_grade', '#kt_datatable_search_program', '#kt_datatable_search_gender', '#kt_datatable_search_accept', '#kt_datatable_search_schoolyear').selectpicker();
		};
