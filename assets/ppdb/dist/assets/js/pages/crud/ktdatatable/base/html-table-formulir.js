/******/ (() => { // webpackBootstrap
	...
	var KTDatatableHtmlTableDemo = function () {
		...
		var demo = function () {
			...
			var datatable = $('#kt_datatable_formulir').KTDatatable({
				sortable: false,
				data: {
				...
				},
				{
					...
					template: function (row) {
						...
						return '<span class="label font-weight-bold label-lg ' + status[row.Pengisian].class + ' label-inline">' + status[row.Pengisian].title + '</span>';
					},
				},
				{
					field: 'No Whatsapp',
			...
			$('#kt_datatable_search_fulfill').on('change', function () {
				datatable.search($(this).val().toLowerCase(), 'Pengisian');
			});
